...
namespace N_Character
{
    namespace N_Player {
        ...
        void Player::choosePokemon(int choice)
        {
            ...
            {
            case PokemonChoice::CHARMANDER:     chosenPokemon = new Pokemon("Charmander", PokemonType::FIRE, 100, 10);
                ...
                break;
            case PokemonChoice::BULBASAUR:     chosenPokemon = new Pokemon("Bulbasaur", PokemonType::GRASS, 100, 8);
                ...
                break;
            case PokemonChoice::SQUIRTLE:     chosenPokemon = new Pokemon("Squirtle", PokemonType::WATER, 100, 9);
